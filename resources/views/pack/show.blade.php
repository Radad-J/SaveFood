                ...
                <div class="col-lg-6">
                    <div class="slick-vertical slick-product">
                        ...
                        <div class="slick-slider carousel-parent" id="carousel-parent" data-items="1" data-swipe="true" data-child="#child-carousel" data-for="#child-carousel">
                            <div class="item">
                                <div class="slick-product-figure"><img src="{{ asset($pack->picture) }}" alt="" width="530" height="480"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="single-product">
                        ...
                        <div class="group-md group-middle">
                            @if(!is_null($pack->sale_price))
                                ...
                                <del style="color:grey !important;" class="single-product-price">{{ $pack->price }}</del>
                            @else
                        ...
                        <ul class="list list-description">
                            <li><span>Claiming days:</span> From {{ \Carbon\Carbon::parse($pack->available_day_from)->format('j F') }} to {{ \Carbon\Carbon::parse($pack->available_day_to)->format('j F') }}</li>
                            <li><span>Claiming hours:</span> From {{ \Carbon\Carbon::parse($pack->available_hour_from)->format('H:i') }} to {{ \Carbon\Carbon::parse($pack->available_hour_to)->format('H:i') }}</li>
