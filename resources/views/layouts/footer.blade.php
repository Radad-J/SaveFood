    ...
    <div class="footer-modern-body section-xl context-dark">
        <div class="container">
            <div class="row row-40 row-md-50 justify-content-xl-between">
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 wow fadeInRight" data-wow-delay=".1s">
                ...
                <div class="col-sm-6 col-md-8 col-lg-2 wow fadeInRight" data-wow-delay=".1s">
                    <h5 class="footer-modern-title">Legal</h5>
                    <ul style="columns:1!important;" class="footer-modern-list footer-modern-list-2">
                    ...
                    <ul class="contacts-creative">
                        <li>
                            <div class="unit unit-spacing-sm flex-column flex-md-row">
                                ...
                                <div class="unit-body"><a href="#">Rue Charles Buls 14, 1000<br/>Brussels, Belgium.</a>
                                </div>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            <div class="unit unit-spacing-sm flex-column flex-md-row">
                                ...
                                <div class="unit-body"><a href="mailto:#">info@savefood.com</a></div>
                            </div>
                        </li>
                    </ul>
