                        ...
                        <div class="row">
                            <div class="col-sm-8 col-md-7">
                                <h2 class="swiper-title-1" data-caption-animate="fadeInLeft" data-caption-delay="100">
                                    Saving the world or saving the food ?
                                    <br>DO BOTH NOW
                                </h2>
                                <h5 class="swiper-title-2 text-width-medium" data-caption-animate="fadeInLeft"
                                    data-caption-delay="250">Horrifying fact ? third of the world's food is wasted every
                                    year.
                                    Join SaveFood for the massive change, all through small purchases.</h5>
                                <div class="button-wrap" data-caption-animate="fadeInLeft" data-caption-delay="400"><a
                                        class="button button-lg button-shadow-5 button-default-outline button-zakaria"
                                        href="{{route('shop.index')}}">Shop now</a></div>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="swiper-slide swiper-slide-2" data-slide-bg="images/slide-2.jpg">
                <div class="swiper-slide-caption section-md text-center">
                    <div class="container">
                        <h2 class="swiper-title-1" data-caption-animate="fadeInLeft" data-caption-delay="100">THE PLANET
                            NEEDS YOU!</h2>
                        <h5 class="swiper-title-2" data-caption-animate="fadeInRight" data-caption-delay="250">SaveFood
                            tries its best to ptevent food shops and restaurants from wasting
                            <br class="d-none d-md-block"> thousands of meals each day we allow you to get your favorite
                            tasty meal for less than its actual price
                        </h5>
    ...
    <section class="section section-xxl bg-image-1">
        <div class="container">
            <div class="row row-xl row-30 row-md-40 row-lg-50 align-items-center">
                                    ...
                                    <div class="unit-left">
                                        <div class="box-icon-classic-svg">
                                            <svg class="svg-icon" x="0px" y="0px" width="53px" height="50px"
                                                ...
                                                <g>
                                                    <path
                                                        d="M38.022,50H14.978V31.77h23.044V50z M15.878,49.081h21.243V32.689H15.878V49.081z"></path>
                                                    <path
                                                        d="M26.5,50c-0.152,0-0.294-0.078-0.377-0.208L15.052,32.481c-0.136-0.213-0.077-0.497,0.131-0.636			c0.208-0.139,0.487-0.079,0.623,0.133L26.5,48.7l10.695-16.722c0.136-0.212,0.415-0.272,0.623-0.133			c0.208,0.139,0.267,0.424,0.131,0.636L26.877,49.792C26.794,49.922,26.652,50,26.5,50z"></path>
                                                    <path
                                                        d="M37.572,50c-0.147,0-0.291-0.073-0.377-0.208L26.5,33.07L15.805,49.792c-0.136,0.212-0.415,0.272-0.623,0.133			c-0.208-0.139-0.267-0.424-0.131-0.636l11.072-17.311c0.083-0.13,0.225-0.208,0.377-0.208s0.294,0.078,0.377,0.208l11.072,17.311			c0.136,0.213,0.077,0.497-0.131,0.636C37.742,49.976,37.657,50,37.572,50z"></path>
                                                    <path
                                                        d="M26.5,50c-0.249,0-0.45-0.206-0.45-0.46V32.229c0-0.254,0.201-0.46,0.45-0.46s0.45,0.206,0.45,0.46V49.54			C26.95,49.794,26.749,50,26.5,50z"></path>
                                                    <path
                                                        d="M30.211,20.307h-7.421V14.82h7.421V20.307z M23.689,19.388h5.621v-3.649h-5.621V19.388z"></path>
                                                    <path
                                                        d="M15.879,50H4.973v-27.28c0-0.254,0.201-0.46,0.45-0.46s0.45,0.206,0.45,0.46v26.361h9.105V32.23			c0-0.254,0.201-0.46,0.45-0.46c0.249,0,0.45,0.206,0.45,0.46V50z"></path>
                                                    <path
                                                        d="M48.027,50H37.122V32.23c0-0.254,0.201-0.46,0.45-0.46c0.249,0,0.45,0.206,0.45,0.46v16.851h9.105V22.719			c0-0.254,0.201-0.46,0.45-0.46c0.249,0,0.45,0.206,0.45,0.46V50z"></path>
                                                    <path
                                                        d="M49.903,27.907l-9.427-17.204L26.5,4.003l-13.977,6.699L3.097,27.907L0,26.137l9.984-18.22L26.5,0l16.517,7.916L53,26.137			L49.903,27.907z M26.5,2.988l14.621,7.008l9.128,16.66l1.526-0.872l-9.402-17.16L26.5,1.016L10.628,8.623l-9.403,17.16l1.526,0.872			l9.128-16.66L26.5,2.988z"></path>
                                                    <path
                                                        d="M26.5,13.665c-0.249,0-0.45-0.206-0.45-0.46V6.264c0-0.254,0.201-0.46,0.45-0.46s0.45,0.206,0.45,0.46v6.942			C26.95,13.46,26.749,13.665,26.5,13.665z"></path>
                                                    <path
                                                        d="M26.5,30.165c-0.249,0-0.45-0.206-0.45-0.46V22.92c0-0.254,0.201-0.46,0.45-0.46s0.45,0.206,0.45,0.46v6.785			C26.95,29.959,26.749,30.165,26.5,30.165z"></path>
                                                    <path
                                                        d="M20.813,30.165c-0.249,0-0.45-0.206-0.45-0.46V9.419c0-0.254,0.201-0.46,0.45-0.46c0.249,0,0.45,0.206,0.45,0.46v20.286			C21.263,29.959,21.062,30.165,20.813,30.165z"></path>
                                                    <path
                                                        d="M32.187,30.165c-0.249,0-0.45-0.206-0.45-0.46V9.419c0-0.254,0.201-0.46,0.45-0.46c0.249,0,0.45,0.206,0.45,0.46v20.286			C32.637,29.959,32.435,30.165,32.187,30.165z"></path>
                                                    <path
                                                        d="M15.87,30.165c-0.249,0-0.45-0.206-0.45-0.46V12.103c0-0.254,0.201-0.46,0.45-0.46c0.249,0,0.45,0.206,0.45,0.46v17.602			C16.32,29.959,16.118,30.165,15.87,30.165z"></path>
                                                    <path
                                                        d="M37.13,30.165c-0.249,0-0.45-0.206-0.45-0.46V12.103c0-0.254,0.201-0.46,0.45-0.46c0.249,0,0.45,0.206,0.45,0.46v17.602			C37.58,29.959,37.379,30.165,37.13,30.165z"></path>
                                                    <path
                                                        d="M10.927,47.836c-0.249,0-0.45-0.206-0.45-0.46V17.563c0-0.254,0.201-0.46,0.45-0.46c0.249,0,0.45,0.206,0.45,0.46v29.813			C11.377,47.63,11.175,47.836,10.927,47.836z"></path>
                                                    <path
                                                        d="M42.074,47.836c-0.249,0-0.45-0.206-0.45-0.46V17.563c0-0.254,0.201-0.46,0.45-0.46s0.45,0.206,0.45,0.46v29.813			C42.524,47.63,42.322,47.836,42.074,47.836z"></path>
                                                </g>
                                            </svg>
                                        </div>
                                    </div>
                                    <div class="unit-body">
                                        <h4 class="box-icon-classic-title"><a href="#">All tasty fresh food</a></h4>
                                        <p class="box-icon-classic-text">We add huge selections of different meals every
                                            hour from different famous trusted restaurants</p>
                                    </div>
                                </div>
                            </article>
                        </div>
                        <div class="col-sm-6 col-md-12">
                            <article
                                ...
                                <div class="unit flex-column flex-lg-row-reverse">
                                        ...
                                        <div class="box-icon-classic-svg">
                                            <svg class="svg-icon" x="0px" y="0px" width="55px" height="55px"
                                                ...
                                                <g>
                                                    ...
                                                    <path
                                                        d="M33.617,18.134c-0.084,0-0.169-0.021-0.247-0.066c-0.237-0.137-0.318-0.44-0.181-0.677l1.718-2.976			c0.137-0.237,0.44-0.318,0.677-0.181c0.237,0.137,0.318,0.44,0.181,0.677l-1.718,2.976C33.955,18.045,33.789,18.134,33.617,18.134z			"></path>
                                                    <path
                                                    ...
                                                    <path
                                                        d="M37.731,22.514c-0.171,0-0.338-0.089-0.43-0.248c-0.137-0.237-0.055-0.54,0.182-0.677l2.975-1.717			c0.237-0.137,0.54-0.056,0.677,0.181c0.137,0.237,0.055,0.54-0.182,0.677l-2.975,1.717C37.9,22.493,37.815,22.514,37.731,22.514z"></path>
                                                    <path
                                                    ...
                                                    <path
                                                        d="M42.536,28.365h-3.437c-0.274,0-0.496-0.222-0.496-0.496c0-0.274,0.222-0.496,0.496-0.496h3.437			c0.274,0,0.496,0.222,0.496,0.496C43.031,28.143,42.809,28.365,42.536,28.365z"></path>
                                                    <path
                                                    ...
                                                    <path
                                                        d="M40.337,35.833c-0.084,0-0.169-0.021-0.247-0.066l-2.976-1.718c-0.237-0.137-0.318-0.44-0.181-0.677			c0.137-0.237,0.44-0.318,0.677-0.181l2.976,1.718c0.237,0.137,0.318,0.44,0.181,0.677C40.674,35.744,40.508,35.833,40.337,35.833z"></path>
                                                    <path
                                                    ...
                                                    <path
                                                        d="M34.699,41.202c-0.171,0-0.338-0.089-0.43-0.248l-1.717-2.975c-0.137-0.237-0.055-0.54,0.181-0.677			c0.237-0.137,0.54-0.055,0.677,0.181l1.717,2.975c0.137,0.237,0.055,0.54-0.182,0.677C34.868,41.18,34.783,41.202,34.699,41.202z"></path>
                                                    <path
                                                    ...
                                                    <path
                                                        d="M27.13,43.032c-0.274,0-0.496-0.222-0.496-0.496v-3.437c0-0.274,0.222-0.496,0.496-0.496s0.496,0.222,0.496,0.496v3.437			C27.626,42.81,27.404,43.032,27.13,43.032z"></path>
                                                    <path
                                                    ...
                                                    <path
                                                        d="M19.662,40.832c-0.084,0-0.169-0.021-0.247-0.066c-0.237-0.137-0.318-0.44-0.181-0.677l1.717-2.975			c0.137-0.237,0.44-0.318,0.677-0.181c0.237,0.137,0.318,0.44,0.181,0.677l-1.717,2.975C20,40.743,19.833,40.832,19.662,40.832z"></path>
                                                    <path
                                                    ...
                                                    <path
                                                        d="M14.294,35.194c-0.171,0-0.338-0.089-0.43-0.248c-0.137-0.237-0.056-0.54,0.181-0.677l2.951-1.703			c0.237-0.137,0.54-0.056,0.677,0.181c0.137,0.237,0.055,0.54-0.182,0.677l-2.951,1.703C14.463,35.173,14.378,35.194,14.294,35.194z			"></path>
                                                    <path
                                                    ...
                                                    <path
                                                        d="M15.852,27.627h-3.389c-0.274,0-0.496-0.222-0.496-0.496s0.222-0.496,0.496-0.496h3.389c0.274,0,0.496,0.222,0.496,0.496			S16.126,27.627,15.852,27.627z"></path>
                                                    <path
                                                    ...
                                                    <path
                                                        d="M19.826,19.289c-0.119,0-0.238-0.043-0.333-0.129c-0.993-0.904-2.073-1.673-3.303-2.353			c-0.24-0.132-0.326-0.434-0.194-0.674c0.133-0.239,0.434-0.326,0.674-0.194c1.298,0.717,2.44,1.531,3.491,2.487			c0.202,0.184,0.217,0.498,0.033,0.7C20.095,19.235,19.961,19.289,19.826,19.289z"></path>
                                                    <path
                                                        d="M17.637,21.877c-0.084,0-0.169-0.021-0.247-0.066l-2.976-1.719c-0.237-0.137-0.318-0.44-0.181-0.677			c0.137-0.237,0.44-0.318,0.677-0.181l2.976,1.719c0.237,0.137,0.318,0.44,0.181,0.677C17.975,21.789,17.809,21.877,17.637,21.877z"></path>
                                                    <path
                                                    ...
                                                    <path
                                                        d="M22.01,17.75c-0.171,0-0.338-0.089-0.43-0.248l-1.709-2.96c-0.137-0.237-0.056-0.54,0.181-0.677			c0.237-0.137,0.54-0.055,0.677,0.181l1.71,2.96c0.137,0.237,0.056,0.54-0.181,0.677C22.18,17.729,22.094,17.75,22.01,17.75z"></path>
                                                    <path
                                                    ...
                                                    <path
                                                        d="M27.868,16.38c-0.274,0-0.496-0.222-0.496-0.496v-3.421c0-0.274,0.222-0.496,0.496-0.496c0.274,0,0.496,0.222,0.496,0.496			v3.421C28.364,16.158,28.142,16.38,27.868,16.38z"></path>
                                                    <path
                                    ...
                                    <div class="unit-body">
                                        <h4 class="box-icon-classic-title"><a href="#">Surprisingly massive
                                                discounts </a></h4>
                                        <p class="box-icon-classic-text">We keep listing different delicious meals with
                                            discounts up to 80%</p>
                                    </div>
                                </div>
                            </article>
                        </div>
                ...
                <div class="col-md-2 col-xl-4 d-none d-md-block wow fadeScale"><img src="images/index-1-399x407.png"
                                                                                    alt="" width="399" height="407"/>
                </div>
                <div class="col-md-5 col-xl-4">
                    <div class="row row-30 row-md-40 row-lg-50 bordered-2">
                        <div class="col-sm-6 col-md-12">
                            <article
                                ...
                                <div class="unit flex-column flex-lg-row">
                                            ...
                                            <svg class="svg-icon" x="0px" y="0px" width="54px" height="58px"
                                                ...
                                                <g>
                                                    <g>
                                                        ...
                                                        <path
                                                            d="M25.375,13.103c-0.247,0-0.466-0.177-0.513-0.43c-0.053-0.286,0.133-0.562,0.417-0.616l2.453-0.465				c0.282-0.054,0.557,0.135,0.61,0.421c0.053,0.286-0.133,0.562-0.417,0.616l-2.453,0.465C25.439,13.1,25.407,13.103,25.375,13.103z				"></path>
                                                        <path
                                                            d="M26.561,18.732c-0.102,0-0.204-0.03-0.295-0.092l-2.061-1.422c-0.238-0.164-0.299-0.493-0.136-0.733				c0.163-0.241,0.488-0.302,0.727-0.138l2.061,1.422c0.238,0.164,0.3,0.493,0.136,0.733C26.891,18.652,26.728,18.732,26.561,18.732z				"></path>
                                                        <path
                                                            d="M18.877,8.62c-0.247,0-0.466-0.177-0.513-0.43l-0.461-2.476c-0.053-0.286,0.133-0.562,0.417-0.616				c0.284-0.054,0.557,0.135,0.61,0.421l0.461,2.476c0.053,0.286-0.133,0.562-0.417,0.616C18.942,8.617,18.909,8.62,18.877,8.62z"></path>
                                                        <path
                                                            d="M23.046,9.503c-0.102,0-0.204-0.03-0.294-0.092c-0.238-0.164-0.3-0.493-0.137-0.733l1.409-2.08				c0.163-0.241,0.488-0.302,0.726-0.138c0.238,0.164,0.3,0.493,0.137,0.733l-1.409,2.08C23.377,9.423,23.213,9.503,23.046,9.503z"></path>
                                                        <path
                                                    ...
                                                    <path
                                                        d="M10.458,58c-0.17,0-0.337-0.084-0.437-0.238c-0.159-0.243-0.092-0.571,0.149-0.731l42.58-28.303			c0.241-0.16,0.565-0.093,0.724,0.151c0.159,0.243,0.092,0.571-0.149,0.731l-42.58,28.303C10.656,57.972,10.556,58,10.458,58z"></path>
                                                    <path
                                                        d="M24.021,58c-0.17,0-0.337-0.084-0.437-0.238c-0.159-0.243-0.092-0.571,0.149-0.731l29.016-19.288			c0.241-0.16,0.565-0.093,0.724,0.15c0.159,0.243,0.092,0.571-0.149,0.731L24.308,57.913C24.22,57.972,24.12,58,24.021,58z"></path>
                                                    <path
                                                        d="M37.582,58c-0.17,0-0.337-0.084-0.437-0.238c-0.159-0.243-0.092-0.571,0.149-0.731l15.455-10.274			c0.241-0.16,0.565-0.093,0.724,0.15c0.159,0.243,0.092,0.571-0.149,0.731L37.869,57.913C37.78,57.972,37.68,58,37.582,58z"></path>
                                                    <path
                                                        d="M32.616,43.271c-0.052,0-0.104-0.008-0.157-0.024L1.165,33.346c-0.276-0.087-0.429-0.383-0.342-0.661			c0.086-0.278,0.379-0.433,0.655-0.346l31.295,9.901c0.276,0.087,0.429,0.383,0.342,0.661			C33.045,43.127,32.839,43.271,32.616,43.271z"></path>
                                                    <path
                                                        d="M24.575,48.615c-0.052,0-0.104-0.008-0.157-0.024L3.62,42.011c-0.276-0.087-0.429-0.383-0.342-0.661			c0.086-0.278,0.38-0.433,0.655-0.346l20.799,6.58c0.275,0.087,0.429,0.383,0.342,0.661C25.004,48.471,24.798,48.615,24.575,48.615z			"></path>
                                                    <path
                                                        d="M16.531,53.962c-0.052,0-0.104-0.008-0.157-0.024l-10.3-3.26c-0.276-0.087-0.429-0.383-0.342-0.661			c0.086-0.278,0.38-0.433,0.655-0.346l10.3,3.26c0.276,0.087,0.429,0.383,0.342,0.661C16.96,53.818,16.754,53.962,16.531,53.962z"></path>
                                                    <g>
                                                        <path
                                                        ...
                                                        <path
                                                            d="M35.845,41.126c-0.289,0-0.523-0.236-0.523-0.528v-8.431c0-0.291,0.234-0.528,0.523-0.528s0.523,0.236,0.523,0.528v8.431				C36.368,40.889,36.134,41.126,35.845,41.126z"></path>
                                                        <path
                                                            d="M38.018,24.571c-0.289,0-0.523-0.236-0.523-0.528v-2.235c0-0.291,0.234-0.528,0.523-0.528				c0.289,0,0.523,0.236,0.523,0.528v2.235C38.541,24.334,38.307,24.571,38.018,24.571z"></path>
                                                        <path
                                                            d="M34.648,24.571c-0.289,0-0.523-0.236-0.523-0.528v-2.235c0-0.291,0.234-0.528,0.523-0.528				c0.289,0,0.523,0.236,0.523,0.528v2.235C35.171,24.334,34.937,24.571,34.648,24.571z"></path>
                                                        <path
                                                            d="M35.419,17.185c-0.289,0-0.523-0.236-0.523-0.528v-2.235c0-0.291,0.234-0.528,0.523-0.528				c0.289,0,0.523,0.236,0.523,0.528v2.235C35.941,16.948,35.707,17.185,35.419,17.185z"></path>
                                                    </g>
                                                    <g>
                                                        <path
                                                        ...
                                                        <path
                                                            d="M46.642,33.948c-0.289,0-0.523-0.236-0.523-0.528v-5.385c0-0.291,0.234-0.528,0.523-0.528				c0.289,0,0.523,0.236,0.523,0.528v5.385C47.165,33.711,46.931,33.948,46.642,33.948z"></path>
                                                        <path
                                                            d="M48.815,20.44c-0.289,0-0.523-0.236-0.523-0.528v-2.235c0-0.291,0.234-0.528,0.523-0.528c0.289,0,0.523,0.236,0.523,0.528				v2.235C49.338,20.204,49.104,20.44,48.815,20.44z"></path>
                                                        <path
                                                            d="M45.445,20.44c-0.289,0-0.523-0.236-0.523-0.528v-2.235c0-0.291,0.234-0.528,0.523-0.528c0.289,0,0.523,0.236,0.523,0.528				v2.235C45.968,20.204,45.734,20.44,45.445,20.44z"></path>
                                                        <path
                                                            d="M46.215,13.054c-0.289,0-0.523-0.236-0.523-0.528v-2.235c0-0.291,0.234-0.528,0.523-0.528				c0.289,0,0.523,0.236,0.523,0.528v2.235C46.738,12.818,46.504,13.054,46.215,13.054z"></path>
                                                    </g>
                                                </g>
                                            </svg>
                                        </div>
                                    ...
                                    <div class="unit-body">
                                        <h4 class="box-icon-classic-title"><a href="#">We save the earth not just
                                                food</a></h4>
                                        <p class="box-icon-classic-text">We are keen to keep it all about environment so
                                            the equation is you save the food we save the planet</p>
                                    </div>
                                </div>
                            </article>
                        </div>
                        <div class="col-sm-6 col-md-12">
                            <article
                                ...
                                <div class="unit flex-column flex-lg-row">
                                    ...
                                    <div class="unit-body">
                                        <h4 class="box-icon-classic-title"><a href="#">Save a meal from wasting, save education</a></h4>
                                        <p class="box-icon-classic-text">How ? 30% of SaveFound earnings is spent on building schools in different countries worldwide</p>
                                    </div>
                                </div>
                            </article>
                        </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        ...
                        <article class="product wow fadeInRight">
                            <div class="product-body">
                                ...
                                <h5 class="product-title"><a href="{{route('pack.show', $featuredpack->id)}}">{{$featuredpack->title}}</a></h5>
                ...
                <div class="row row-30 justify-content-center">
                    <div class="col-6 col-sm-3">
                        <div class="counter-modern">
                            ...
                            <h5 class="counter-modern-title">New food products<br class="d-none d-sm-block"> and drinks
                            </h5>
                        </div>
                    </div>
                    <div class="col-6 col-sm-3">
                    ...
                    <div class="col-6 col-sm-3">
                        <div class="counter-modern">
                            ...
                            <div class="counter-modern-decor"></div>
                            <h5 class="counter-modern-title">Partners throughout<br class="d-none d-sm-block"> the USA
                            </h5>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="owl-carousel owl-style-5" data-items="1" data-margin="30" data-dots="true"
                                ...
                                @for($i=0;$i<3;$i++)
                                    <article class="product-creative">
                                        <div class="product-figure"><img
                                                src="{{asset('images/uploads/packs/'.$featuredPacks[$i]->picture)}}"
                                                alt="{{$featuredPacks[$i]->title}}"
                                                width="470" height="324"/>
                                        </div>
                                        <h4 class="product-creative-title"><a
                                                href="{{route('pack.show',$featuredPacks[$i]->id)}}">{{$featuredPacks[$i]->title}}</a>
                                        </h4>
                                        @if(is_null($featuredpack->sale_price))
                                            <div class="product-creative-price">{{$featuredPacks[$i]->price}}</div>
                                        @else
                                            <div class="product-creative-price-wrap">
                                                <div
                                                    class="product-creative-price product-creative-price-old">{{$featuredPacks[$i]->price}}</div>
                                                <div
                                                    class="product-creative-price">{{$featuredPacks[$i]->sale_price}}</div>
                                            </div>
                                        @endif
                                    </article>
                                @endfor
                    ...
                    <div class="card-group-custom card-group-corporate" id="accordion1" role="tablist"
                        ...
                        <article class="card card-custom card-corporate wow fadeInRight" data-wow-delay=".1s">
                            <div class="card-header" role="tab">
                                <div class="card-title"><a id="accordion1-card-head-oegbwmug" data-toggle="collapse"
                                                           data-parent="#accordion1"
                                                           href="#accordion1-card-body-alhwunqo"
                                                           aria-controls="accordion1-card-body-alhwunqo"
                                                           aria-expanded="true" role="button">SaveFood supports
                                        restaurants owners
                            ...
                            <div class="collapse show" id="accordion1-card-body-alhwunqo"
                                 aria-labelledby="accordion1-card-head-oegbwmug" data-parent="#accordion1"
                                 role="tabpanel">
                                <div class="card-body">
                                    <p>We try our best to prevent restaurants from wasting food by allowing them to list
                                        their tasty meals for less than their actual prices.</p>
                                </div>
                            </div>
                        </article>
                        <!-- Bootstrap card-->
                        <article class="card card-custom card-corporate wow fadeInRight" data-wow-delay=".2s">
                            <div class="card-header" role="tab">
                                <div class="card-title"><a class="collapsed" id="accordion1-card-head-uwjbrtcw"
                                                           data-toggle="collapse" data-parent="#accordion1"
                                                           href="#accordion1-card-body-yxayciuu"
                                                           aria-controls="accordion1-card-body-yxayciuu"
                                                           aria-expanded="false" role="button">SaveFood saving the
                                        planet
                                        Animals
                                        <div class="card-arrow">
                                            <div class="icon"></div>
                            ...
                            <div class="collapse" id="accordion1-card-body-yxayciuu"
                                 aria-labelledby="accordion1-card-head-uwjbrtcw" data-parent="#accordion1"
                                 role="tabpanel">
                                <div class="card-body">
                                    <p>How is this relevant ? all the wasted food is responsible for massive amount of
                        ...
                        <article class="card card-custom card-corporate wow fadeInRight" data-wow-delay=".3s">
                            <div class="card-header" role="tab">
                                <div class="card-title"><a class="collapsed" id="accordion1-card-head-ltjwwjqy"
                                                           data-toggle="collapse" data-parent="#accordion1"
                                                           href="#accordion1-card-body-pbcrxcjw"
                                                           aria-controls="accordion1-card-body-pbcrxcjw"
                                                           aria-expanded="false" role="button">SaveFood helps the poor
                                        people
                                        <div class="card-arrow">
                                            <div class="icon"></div>
                                        </div>
                            ...
                            <div class="collapse" id="accordion1-card-body-pbcrxcjw"
                                 aria-labelledby="accordion1-card-head-ltjwwjqy" data-parent="#accordion1"
                                 role="tabpanel">
                                <div class="card-body">
                ...
                <div class="col-xl-9">
                    <div class="slick-quote">
                        ...
                        <div class="slick-slider carousel-parent" id="carousel-parent" data-autoplay="true"
                            ...
                            <div class="item">
                                <p class="quote-minimal-text">I absolutely love the high quality of the food and the
                                    great customer service. I’ve been customers since 2006 and love the Burgundy Pepper
                                    London Broil.</p>
                            </div>
                            <div class="item">
                                <p class="quote-minimal-text">I love not having to run to the grocery store all the time
                                    for last minute things. Everything I need is already here and it’s healthier,
                                    hormone-free.</p>
                            </div>
                            <div class="item">
                                <p class="quote-minimal-text">As a 5+ year customer, I enjoy the quality of vegetables
                                    knowing that my family is getting good quality products. A great experience all the
                                    way round.</p>
                            </div>
                        </div>
                        <div class="slick-quote-nav">
                            <div class="slick-slider child-carousel" id="child-carousel" data-arrows="true"
                                ...
                                <div class="item">
                                    <div class="quote-minimal-figure"><img src="images/user-7-87x87.jpg" alt=""
                                                                           width="87" height="87"/>
                                    </div>
                                    <div class="quote-minimal-author">Patricia Goodman</div>
                                    <div class="quote-minimal-status">Client</div>
                                </div>
                                <div class="item">
                                    <div class="quote-minimal-figure"><img src="images/user-8-87x87.jpg" alt=""
                                                                           width="87" height="87"/>
                                    </div>
                                    <div class="quote-minimal-author">Jane Smith</div>
                                    <div class="quote-minimal-status">Client</div>
                                </div>
                                <div class="item">
                                    <div class="quote-minimal-figure"><img src="images/user-9-87x87.jpg" alt=""
                                                                           width="87" height="87"/>
                                    </div>
